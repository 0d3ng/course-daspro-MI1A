...
#### Jawaban
1. Tidak
2. Tambahkan System.out.println(); di outer agar tampilan berubah
...
#### Jawaban
1. Program yang dibuat untuk menebak angka dengan random, jika tebak an benar maka program akan berhenti. Program tersebut menggunakan nested loop do-while. Oleh karena itu, statement dahulu yang dijalankan setelah itu baru kondisi.
2. Dengan menggunakan pertanyaan dengan jawaban selain Y/y
